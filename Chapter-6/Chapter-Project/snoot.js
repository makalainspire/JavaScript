/*   JavaScript 6th Edithion
      ...
      Filename: snoot.js  */
"use strict"; //interpret contents of document in JavaScript strict mode

/* global variables */
var twentyNine = document.createDocumentFragment();
var thirty = document.createDocumentFragment();
var thirtyOne = document.createDocumentFragment();
var formVailidity = true;
...
function updateDays() {
    ...
    if (deliveryYear.selectedIndex === -1) {
        //IF NO YEAR IS SELECTED, CHOOSE THE DEFAULT YEAR SO THE LENGTH OF fEB CAN BE DETERMINED
...
/* auto check custom message check box if user makes entry in customText box */
...
/* copy values for Billing Address fields to delivery address feilds */
    ...
    try {
        ...
        if (fieldsetValidity === false) {
            ...
            if (fieldsetId === "billingAddress") {
                throw "Please fill out billing info";
            } else {
                throw "Please fill out delivery info"
            }
        }
            else {
...
function validateForm(evt) {
    ...
    formVailidity = true; //reset value for revalidation
    validateAddress("billingAddress");
    validateAddress("deliveryAddress");
    validateDeliveryDate();
    validatePayment();
    validateMessage();
    if (formVailidity === true) {
        document.getElementById("errorText").innerHTML = "";
        document.getElementById("errorText").style.display = "none";
        document.getElementsByTagName("form")[0].submit();
    } else {
        document.getElementById("errorText").innerHTML = "Please suck a dick";
