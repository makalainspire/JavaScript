...
function previewFive() {
 //create figure and img elements for fifth image
    ...
    //clone figure element for the fifth image and edit to be the first image
    ...
    //change button to hide extra image
    ...
    if (numberButton.addEventListener) {
        ...
        numberButton.attachEvent("onlick", previewThree);
    }
}
...
/*create event listeners for left arrow, right arrow, and center figure elements*/
